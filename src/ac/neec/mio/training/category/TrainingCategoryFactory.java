...
/**
 * TrainingCategoryクラスを生成するクラス
 *
 */
public class TrainingCategoryFactory extends ProductDataFactory {

	@Override
	protected ProductData factoryMethod(int trainingCategoryId,
			String trainingCategoryName) {
		return new TrainingCategory(trainingCategoryId, trainingCategoryName);
	}
