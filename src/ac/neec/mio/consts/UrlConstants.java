...
public class UrlConstants extends AppConstants {
	...
	public static void init(Resources resources) {
		UrlConstants.resources = resources;
	}
	...
	public static String trainingSelectAll() {
		return resources.getString(R.string.training_select_all);
	}
	...
	public static String trainingSelectLog() {
		return resources.getString(R.string.training_select_log);
	}

	public static String trainingSelectPlay() {
		return resources.getString(R.string.training_select_play);
	}
	...
	public static String menuSelect() {
		return resources.getString(R.string.menu_select);
	}
	...
	public static String trainingId() {
		return resources.getString(R.string.training_id);
	}
	...
	public static String num() {
		return resources.getString(R.string.num);
	}

	public static String logTargetHeartRate() {
		return resources.getString(R.string.log_target_heart_rate);
	}

	public static String calorie() {
		return resources.getString(R.string.calorie);
	}

	public static String distance() {
		return resources.getString(R.string.distance);
	}
	...
	public static String palyId() {
		return resources.getString(R.string.play_id);
	}

	public static String trainingTime() {
		return resources.getString(R.string.training_time);
	}

	public static String categoryId() {
		return resources.getString(R.string.category_id);
	}
