...
import static ac.neec.mio.consts.Constants.color;
import static ac.neec.mio.consts.Constants.compelWithdrawal;
import static ac.neec.mio.consts.Constants.consumptionCal;
import static ac.neec.mio.consts.Constants.date;
import static ac.neec.mio.consts.Constants.disX;
import static ac.neec.mio.consts.Constants.disY;
import static ac.neec.mio.consts.Constants.dissolution;
import static ac.neec.mio.consts.Constants.distance;
import static ac.neec.mio.consts.Constants.groupInfoChange;
import static ac.neec.mio.consts.Constants.groupInfoView;
import static ac.neec.mio.consts.Constants.groupNews;
import static ac.neec.mio.consts.Constants.heartRate;
import static ac.neec.mio.consts.Constants.heartRateAvg;
import static ac.neec.mio.consts.Constants.id;
import static ac.neec.mio.consts.Constants.joinStatus;
import static ac.neec.mio.consts.Constants.lap;
import static ac.neec.mio.consts.Constants.logId;
import static ac.neec.mio.consts.Constants.memberAddManage;
import static ac.neec.mio.consts.Constants.memberDataCheck;
import static ac.neec.mio.consts.Constants.memberListView;
import static ac.neec.mio.consts.Constants.mets;
import static ac.neec.mio.consts.Constants.name;
import static ac.neec.mio.consts.Constants.permissionChange;
import static ac.neec.mio.consts.Constants.permissionId;
import static ac.neec.mio.consts.Constants.playId;
import static ac.neec.mio.consts.Constants.playTime;
import static ac.neec.mio.consts.Constants.selectPermissionTable;
import static ac.neec.mio.consts.Constants.selectTrainingCategoryTable;
import static ac.neec.mio.consts.Constants.selectTrainingLogTable;
import static ac.neec.mio.consts.Constants.selectTrainingMenuTable;
import static ac.neec.mio.consts.Constants.selectTrainingPlayTable;
import static ac.neec.mio.consts.Constants.selectTrainingTable;
import static ac.neec.mio.consts.Constants.split;
import static ac.neec.mio.consts.Constants.startTime;
import static ac.neec.mio.consts.Constants.strange;
import static ac.neec.mio.consts.Constants.tablePermission;
import static ac.neec.mio.consts.Constants.tableTraining;
import static ac.neec.mio.consts.Constants.tableTrainingCategory;
import static ac.neec.mio.consts.Constants.tableTrainingLog;
import static ac.neec.mio.consts.Constants.tableTrainingMenu;
import static ac.neec.mio.consts.Constants.tableTrainingPlay;
import static ac.neec.mio.consts.Constants.targetCal;
import static ac.neec.mio.consts.Constants.targetHeartRate;
import static ac.neec.mio.consts.Constants.time;
import static ac.neec.mio.consts.Constants.trainingCategoryId;
import static ac.neec.mio.consts.Constants.trainingCategoryName;
import static ac.neec.mio.consts.Constants.trainingMenuId;
import static ac.neec.mio.consts.Constants.trainingName;
import static ac.neec.mio.consts.Constants.trainingTime;
import static ac.neec.mio.consts.Constants.userId;
import static ac.neec.mio.consts.Constants.withdrawal;
